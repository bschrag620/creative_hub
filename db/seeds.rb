...
q = Question.create(:text => "Which objects are ok to stick into the electrical outlet?")
...
q = Question.create(:text => "Which objects are not ok to stick into the electrical outlet?")
